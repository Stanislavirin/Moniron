...
QT_MOC_LITERAL(5, 70, 16) // "readSettingsData"

    },
    "Authwindow\0firstWindow\0\0on_pushButton_clicked\0"
    "on_pushButton_2_clicked\0readSettingsData"
};
...
void Authwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->readSettingsData(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Authwindow::firstWindow)) {
                *result = 0;
                return;
            }
        }
